...
urlpatterns = [
    ...
    path("ofertas/", include(("listings.public_urls", "public_listings"))),
    path("procuras/", include(("leads.procuras_urls", "procuras"))),
    path("interesses/", include(("leads.interesses_urls", "interesses"))),
